...
import gameConsole.PirateGame;
import gameConsole.extraGameFeatures.Combatant;
import gameConsole.extraGameFeatures.Feature;
import gameConsole.extraGameFeatures.Loot;
...
public final class Pirate extends Combatant {
    ...
    public Pirate(String name) {
        super(name, Map.of("level", 0, "townsIndex", 0));
        visitTown();
    }
