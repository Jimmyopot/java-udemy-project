package FileExceptions.RandomAccessChallenge;

import java.io.IOException;
import java.io.RandomAccessFile;
import java.util.*;

record Employee(int employeeId, String firstName, String last, double salary) {}
public class Main {
    ...
    public static void main(String[] args) {
        try (RandomAccessFile ra =
                new RandomAccessFile("student.dat", "rw")) {
