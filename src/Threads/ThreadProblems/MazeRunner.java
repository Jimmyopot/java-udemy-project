package Threads.ThreadProblems;
...
class ParicipantThread extends Thread {
    public final Participant participant;

    public ParicipantThread(Participant participant) {
...
public class MazeRunner {
    public static void main(String[] args) {
        ...
        var adamsResults = executor.submit(new ParicipantThread(adam));
        var gracesResults = executor.submit(new ParicipantThread(grace));
