package DateTimeProject.MoreTime;
...
public class Main {
    public static void main(String[] args) {
        ...
        LocalDateTime nowInLA = LocalDateTime.now();
        ...
        Instant dobInstant = Instant.parse("2024-01-01T08:01:00Z");
        LocalDateTime dob =
        ...
        ZonedDateTime dobSydney =
                ZonedDateTime.ofInstant(dobInstant,
                        ZoneId.of("Australia/Sydney"));
