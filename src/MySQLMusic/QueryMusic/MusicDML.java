...
public class MusicDML {
    ...
    public static boolean deleteRecord(Statement statement, String table,
    ...
    public static boolean updateRecord(Statement statement, String table,
                                       String matchedColumn, String matchedValue,
                                       String updateColumn, String updateValue)
            throws SQLException {
        String query = "UPDATE %s SET %s = '%s' WHERE %s='%s'"
                .formatted(table, updateColumn, updateValue, matchedColumn,
                        matchedValue);
        System.out.println(query);
        statement.execute(query);
    ...
    public static void insertArtistAlbum(Statement statement, String artistName,
                                         String albumName)
        throws SQLException {
